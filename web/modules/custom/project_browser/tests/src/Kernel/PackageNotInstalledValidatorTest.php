...
class PackageNotInstalledValidatorTest extends PackageManagerKernelTestBase {
  ...
  public function providerPreRequireException(): array {
    $summary = 'The following package is already installed: @module';
    $summary_plural = 'The following packages are already installed: @modules';
    ...
    return [
      ...
      'already installed package' => [
        ['drupal/my_module'],
        ValidationResult::createError([t($summary, ['@module' => 'drupal/my_module'])]),
      ],
      ...
      '2 packages sent, both already installed' => [
        ...
        ValidationResult::createError([t($summary_plural, ['@modules' => 'drupal/my_module, drupal/my_module_2'])]),
      ],
    ];
  }
